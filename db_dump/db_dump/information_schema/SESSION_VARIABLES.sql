...
--  テーブル information_schema.SESSION_VARIABLES の構造をダンプしています
...
-- テーブル information_schema.SESSION_VARIABLES: 567 rows のデータをダンプしています
