...
--  テーブル information_schema.COLLATION_CHARACTER_SET_APPLICABILITY の構造をダンプしています
...
-- テーブル information_schema.COLLATION_CHARACTER_SET_APPLICABILITY: 234 rows のデータをダンプしています
