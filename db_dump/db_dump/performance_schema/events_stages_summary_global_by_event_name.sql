...
--  テーブル performance_schema.events_stages_summary_global_by_event_name の構造をダンプしています
...
-- テーブル performance_schema.events_stages_summary_global_by_event_name: 0 rows のデータをダンプしています
